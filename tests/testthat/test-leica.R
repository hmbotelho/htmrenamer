...
test_that("renaming widefield files", {
    ...
    # Test data
    path_dataset_raw     <- "./sample_data/Leica/widefield_raw/leica_widefield--2019_05_18_13_45_38"
    path_dataset_renamed <- "./sample_data/Leica/widefield_renamed/leica"
    path_infile          <- "./sample_data/Leica/leica.txt"
    ...
    # Rename files
    rename_leica(sourcefolder = path_dataset_raw,
...
test_that("renaming confocal files", {
    ...
    # Test data
    path_dataset_raw     <- "./sample_data/Leica/confocal_raw/leica_confocal--2019_05_18_14_21_39"
    path_dataset_renamed <- "./sample_data/Leica/confocal_renamed/leica"
    path_infile          <- "./sample_data/Leica/leica.txt"
